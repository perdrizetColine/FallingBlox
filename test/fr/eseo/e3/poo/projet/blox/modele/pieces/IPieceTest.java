...
public class IPieceTest {
	...
	void testConstructeur() {
		...
		assertEquals(new Coordonnees(6,4),IPiece2.getElements().get(1).getCoordonnees(),"coordonnes 2");
		assertEquals(new Coordonnees(6,3),IPiece2.getElements().get(2).getCoordonnees(),"coordonnes 2");
		assertEquals(new Coordonnees(6,2),IPiece2.getElements().get(3).getCoordonnees(),"coordonnes 2");
	}
